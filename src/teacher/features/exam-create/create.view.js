      ...
      <div class="bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-sm border dark:border-gray-700 w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
          <div>
            ...
            <select id="nsub" class="w-full p-3 border dark:border-gray-700 dark:bg-black dark:text-white rounded-xl">
          ...
          <div>
            ...
            <select id="nchap" class="w-full p-3 border dark:border-gray-700 dark:bg-black dark:text-white rounded-xl">
          ...
          <div class="question-box dark:bg-black dark:border-gray-700 w-full">
                ...
                ${['A', 'B', 'C', 'D'].map((letter, index) => `
                  <div class="flex items-center gap-2 w-full">
                    ...
                    <div class="question-field-container flex-1 w-full">
                      <textarea id="option-${letter.toLowerCase()}" class="w-full p-2 border dark:border-gray-700 dark:bg-black dark:text-white rounded option-textarea auto-resize box-border" rows="2" placeholder="Option ${letter}" oninput="window.autoResizeTextarea(this)"></textarea>
            ...
            <div class="mb-3 w-full">
              ...
              <div class="question-field-container w-full">
                <textarea id="explanation" class="w-full p-2 border dark:border-gray-700 dark:bg-black dark:text-white rounded explanation-textarea auto-resize box-border" rows="2" placeholder="Add explanation for this question (optional)..." oninput="window.autoResizeTextarea(this)"></textarea>
